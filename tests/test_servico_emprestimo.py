...
@pytest.mark.parametrize("equip_id, dias_atraso, multa_esperada", [
    (1, 3, 30.0), (1, 1, 10.0),
    (2, 2, 30.0), (2, 4, 60.0),
    (3, 5, 10.0), (3, 1, 2.0)
])
def test_devolver_calcula_multa_correta_para_atraso(servico, repositorio_fake, notificador_spy, equip_id, dias_atraso, multa_esperada):
